...
|--------|---------|--------|:---:|------|------|-------------|
| Ростов-на-Дону | Кабан | Осень | ✅ | 01.10 | 31.12 | по путёвке |
| Ростов-на-Дону | Судак | Весна | ❌ | — | — | нерестовый запрет |
| Ростов-на-Дону | Заяц-русак | Зима | ✅ | 01.11 | 15.01 | — |
| Ростов-на-Дону | Сазан | Лето | ✅ | 16.06 | 31.08 | суточная норма |

> **Scope прототипа:** проработан один регион — **Ростов-на-Дону**. Модель и
> схема рассчитаны на много регионов; остальные добавляются позже (вне scope).
