/*
 * supabase.js — обёртка над Supabase (auth + данные).
 * Требует подключённого CDN @supabase/supabase-js (window.supabase) и ключей
 * в config.js. Если не настроено — SB.enabled = false, страницы работают в
 * демо-режиме (без реального входа).
 */
const SB = (() => {
